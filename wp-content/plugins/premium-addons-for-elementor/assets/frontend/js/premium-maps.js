    ...
    var PremiumMapsHandler = function ($scope, $) {
        ...
        function newMap(map, settings, mapStyle) {
            ...
            var scrollwheel = JSON.parse(settings["scrollwheel"]),
                streetViewControl = JSON.parse(settings["streetViewControl"]),
                fullscreenControl = JSON.parse(settings["fullScreen"]),
                zoomControl = JSON.parse(settings["zoomControl"]),
                mapTypeControl = JSON.parse(settings["typeControl"]),
                centerLat = JSON.parse(settings["centerlat"]),
                centerLong = JSON.parse(settings["centerlong"]),
                autoOpen = JSON.parse(settings["automaticOpen"]),
                hoverOpen = JSON.parse(settings["hoverOpen"]),
                hoverClose = JSON.parse(settings["hoverClose"]),
                args = {
                    zoom: settings["zoom"],
